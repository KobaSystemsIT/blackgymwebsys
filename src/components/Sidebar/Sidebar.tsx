...
const Sidebar: React.FC<SidebarProps> = ({ }) => {
	...
	return (
		<div className="h-full md:overflow-y-auto md:overflow-x-hidden bg-black rounded-2xl">
			<div className="pt-24">
				<div className="flex flex-col items-center">
					<div className="flex flex-col pt-6 justify-center">
						<img src={logo} className="lg:h-14 md:h-12 h-10" alt="Logo" />
						<h1 className="lg:text-2xl lg:block md:hidden md:text-lg hidden text-base mt-5 font-medium bottom-0 text-center text-white ">
							Black Gym Club
						</h1>
					</div>
				</div>
						...
						<li className="m-5 hover:bg-white rounded-md hover:text-black">
							<a href="/" className="flex items-center">
								<FontAwesomeIcon
									...
									className="h-5 m-2"
								/>
								<h1 className='lg:block md:hidden hidden'>Inicio</h1>
							</a>
						</li>
						{!isAdmin && (
